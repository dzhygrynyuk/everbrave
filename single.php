...
<main class="main page-post">
				...
				<div class="post_header_info">
					<div class="post_header_info_top">
						<div class="post-author">
							<div class="post-author-photo bgi"
								style="background-image: url('<?php echo get_avatar( get_the_author_meta(’email’) , 60 ); ?>">
							</div>
	...
	<section class="post-form">
		<div class="container">
			...
			<div class="wrap">
				<h3 class="title">
					Was this article helpful? Subscribe 
					to receive more useful content like this.
				</h3>
			</div>
	...
	<section class="home-posts-sec">
		<div class="container">	
			...
			<div class="posts-box">
				<div class="item">
					<a href="#"><img src="<?php echo get_template_directory_uri();?>/assets/img/test/post-img.jpg" alt="Image"></a>
					<div class="content-box">
						<ul class="tags">
							<li><a href="#">Featured</a></li>
							<li><a href="#">Branding</a></li>
						</ul>
						<a href="#" class="title">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et</a>
				...
				<div class="item">
					<a href="#">
						<img src="<?php echo get_template_directory_uri();?>/assets/img/test/post-img-2.jpg" alt="Image">
					</a>
					<div class="content-box">
						<ul class="tags">
							<li><a href="#">Featured</a></li>
				...
				<div class="item">
					<a href="#"><img src="<?php echo get_template_directory_uri();?>/assets/img/test/post-img-3.jpg" alt="Image"></a>
					<div class="content-box">
						<ul class="tags">
							<li><a href="#">Featured</a></li>
							<li><a href="#">Branding</a></li>
